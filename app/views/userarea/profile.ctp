...
<?//$this->element('std_input', array('plugin' => 'core', 'caption' => 'Ваше имя', 'field' => 'User.username', 'data' => $data))?>
<tr>
	<td>Ваше имя</td>
	<td>
		<input type="text" name="data[UserProfile][username]" value="<?=$this->PHA->read($data, 'UserProfile.username')?>" disabled="disabled" />
	</td>
</tr>
